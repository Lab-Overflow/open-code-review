...
description: >
  ...
  Lab-Overflow/open-code-review. Use when the user asks to review code, review
...
compatibility: >
  ...
  @lab-overflow/open-code-review` or GitHub release binary). Requires a
  configured LLM (Anthropic or OpenAI-compatible) before first run.
metadata:
  author: Lab-Overflow
  homepage: https://github.com/Lab-Overflow/open-code-review
  version: "1.0.0"
---
...
A skill for invoking [open-code-review](https://github.com/Lab-Overflow/open-code-review) (`ocr`) — an open-source AI code review CLI that reads Git diffs and generates structured, line-level review comments.
...
- **Installation**: if `ocr` command is not found, install it by running `npm i -g @lab-overflow/open-code-review`
...
- Full docs: https://github.com/Lab-Overflow/open-code-review
- NPM package: https://www.npmjs.com/package/@lab-overflow/open-code-review
- Issue tracker: https://github.com/Lab-Overflow/open-code-review/issues
