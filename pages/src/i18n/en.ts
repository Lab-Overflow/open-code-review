...
export const en: TranslationKeys = {
  ...
  'hero.description': 'Open Code Review brings Lab-Overflow\'s battle-tested code review Agent into your workflow. Connect any LLM, keep data fully private, and get review comments developers actually adopt.',
  ...
  'highlights.stat1Caption': 'Maintained by Lab-Overflow',
  'highlights.stat2Value': '> 30%',
  'highlights.stat2Label': 'ADOPTION RATE',
  'highlights.stat2Caption': 'Independent open source project',
  ...
  'features.feat3Desc': 'Supports both Anthropic Messages API and OpenAI Chat Completions API. Ships with preset providers including Anthropic, OpenAI, DeepSeek, and Z.AI for out-of-the-box use, while also supporting custom model endpoints for private deployments.',
