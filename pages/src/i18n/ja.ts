...
export const ja: TranslationKeys = {
  ...
  'hero.description': 'Open Code Review は、Lab-Overflowの実戦検証済みコードレビュー Agent をワークフローに統合します。任意の LLM に接続し、データを完全にプライベートに保ち、開発者が実際に採用するレビューコメントを取得できます。',
  ...
  'highlights.stat1Caption': 'Lab-Overflowグループ内で実戦検証済み',
  'highlights.stat2Value': '> 30%',
  'highlights.stat2Label': '採用率',
  'highlights.stat2Caption': 'Lab-Overflowグループ内で実戦検証済み',
  ...
  'features.feat3Desc': 'Anthropic Messages API と OpenAI Chat Completions API の両方をサポート。Anthropic、OpenAI、DeepSeek、Z.AI などのプリセットプロバイダーを内蔵し、カスタムモデルエンドポイントにも対応。',
