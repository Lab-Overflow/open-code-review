...
export const zh: TranslationKeys = {
  ...
  // Hero
  'hero.title': 'AI 代码审查\n百万真实任务验证',
  'hero.description': 'Open Code Review 将Lab-Overflow经过实战检验的代码审查 Agent 引入您的工作流程。连接任意 LLM，数据完全私有，获得开发者真正采纳的审查意见。',
  ...
  'highlights.stat1Caption': '经Lab-Overflow集团内部实战验证',
  'highlights.stat2Value': '> 30%',
  'highlights.stat2Label': '采纳率',
  'highlights.stat2Caption': '经Lab-Overflow集团内部实战验证',
  ...
  'features.feat3Desc': '同时支持 Anthropic Messages API 和 OpenAI Chat Completions API。内置 Anthropic、OpenAI、DeepSeek、Z.AI 等预设提供商，开箱即用，同时支持自定义模型端点用于私有化部署。',
