...
const Footer: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <a href="https://github.com/Lab-Overflow/open-code-review" target="_blank" rel="noopener noreferrer" style={{ display: 'flex', alignItems: 'center', gap: 6, textDecoration: 'none' }}>
