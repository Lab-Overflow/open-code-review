...
```bash
npm install -g @lab-overflow/open-code-review@<version>
```
...
```bash
npm uninstall -g @lab-overflow/open-code-review
```
...
[releases ページ](https://github.com/Lab-Overflow/open-code-review/releases) から
静的バイナリを直接取得できます。
...
```bash
curl -LO https://github.com/Lab-Overflow/open-code-review/releases/latest/download/sha256sum.txt
