...
[`CONTRIBUTING.md`](https://github.com/Lab-Overflow/open-code-review/blob/main/CONTRIBUTING.md) にあります。
...
- **バグ報告**——再現手順を添えて
  [GitHub issue](https://github.com/Lab-Overflow/open-code-review/issues/new/choose) を作成してください。
- **機能リクエスト**——
  [Discussions](https://github.com/Lab-Overflow/open-code-review/discussions/categories/ideas)
...
1. [`internal/config/toolsconfig/tools.json`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/config/toolsconfig/tools.json)
...
4. **ドキュメントを更新してください。** 変更が引数、config key、レビューパイプラインに影響する場合は、
   本ドキュメントサイト（[`docs/`](https://github.com/Lab-Overflow/open-code-review) 内）と関連するインラインヘルプの
   両方を更新してください。
5. **PR テンプレートを記入してください。** メンテナーがレビューします。通常は数営業日以内です。

## コントリビューターライセンス契約（CLA）

本プロジェクトは Contributor License Agreement を必要とします。初めて PR を出すと bot がリンクを貼ります——
電子署名してください（1 分程度）。以降の PR では再署名は不要です。

## 初めての貢献ですか？

[`good first issue`](https://github.com/Lab-Overflow/open-code-review/labels/good%20first%20issue)
または [`help wanted`](https://github.com/Lab-Overflow/open-code-review/labels/help%20wanted)
...
- 完全な貢献ガイド:
  [CONTRIBUTING.md](https://github.com/Lab-Overflow/open-code-review/blob/main/CONTRIBUTING.md)
