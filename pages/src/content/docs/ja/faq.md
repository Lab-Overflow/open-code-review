...
[GitHub issue](https://github.com/Lab-Overflow/open-code-review/issues) を作成してください。
...
[issue トラッカー](https://github.com/Lab-Overflow/open-code-review/issues)をご覧ください。

## その他

### changelog はどこにある？

[GitHub Releases](https://github.com/Lab-Overflow/open-code-review/releases)
...
provider が必要です。Hg サポートの issue は[こちら](https://github.com/Lab-Overflow/open-code-review/issues)で
オープンになっています。
...
```bash
npm uninstall -g @lab-overflow/open-code-review        # NPM install
