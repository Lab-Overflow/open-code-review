...
[`internal/agent/preview.go`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/agent/preview.go).
...
4. **`unsupported_ext`** — Is the file extension in the
   [allowlist](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/config/allowlist/supported_file_types.json)?
   Excluded if not.
...
[`internal/config/allowlist/default_exclude_patterns.json`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/config/allowlist/default_exclude_patterns.json))
...
[`internal/diff/git.go`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/diff/git.go),
