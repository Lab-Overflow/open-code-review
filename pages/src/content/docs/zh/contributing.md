...
- **Bug 报告**——开一个带复现步骤的
  [GitHub issue](https://github.com/Lab-Overflow/open-code-review/issues/new/choose)。
- **功能请求**——在
...
4. **更新文档。** 若变更影响参数、config key 或评审流水线，同时更新本文档站
  （在 [`docs/`](https://github.com/Lab-Overflow/open-code-review)）与任何相关内联帮助。
5. **填写 PR 模板。** 维护者会评审，通常几个工作日内。

## 贡献者许可协议（CLA）

本项目要求 Contributor License Agreement。首次开 PR 时会有 bot 贴链接——电子签署
（一分钟）。后续 PR 无需重签。
...
或 [`help wanted`](https://github.com/Lab-Overflow/open-code-review/labels/help%20wanted)
