...
编排逻辑位于
[`internal/agent/`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/agent/)
...
diff 加载后，每个文件经过
[`whyExcluded`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/agent/preview.go)。
该函数返回以下之一：
...
占位符替换位于
[`agent.go`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/agent/agent.go)。
模板本身不是 CLI 覆盖——要修改 prompt，你需要编辑
[`task_template.json`](https://github.com/Lab-Overflow/open-code-review/blob/main/internal/config/template/task_template.json)
