<div align="center">
  <a href="https://lab-overflow.github.io/open-code-review/">
...
<p align="center">
  <a href="https://trendshift.io/repositories/41087" target="_blank">
    <img src="https://trendshift.io/api/badge/trendshift/repositories/41087/weekly?language=Go" alt="Lab-Overflow%2Fopen-code-review | Trendshift" style="width: 320px; height: 70px;" width="320" height="70" />
  </a>
</p>
<p align="center">
  ...
  <a href="https://deepwiki.com/Lab-Overflow/open-code-review"><img alt="Ask DeepWiki" src="https://deepwiki.com/badge.svg" /></a>
...
Open Code Review — это CLI-инструмент для код-ревью на основе ИИ, который Lab-Overflow поддерживает как личный open-source-проект. Он помогает добавить структурированные построчные AI-review комментарии в локальные и CI-процессы. Чтобы начать работу, достаточно настроить эндпоинт модели.
...
Подробнее на [официальном сайте](https://lab-overflow.github.io/open-code-review/).
...
Скачайте бинарный файл для вашей платформы со страницы [GitHub Releases](https://github.com/Lab-Overflow/open-code-review/releases):

```bash
# macOS (Apple Silicon)
curl -Lo ocr https://github.com/Lab-Overflow/open-code-review/releases/latest/download/opencodereview-darwin-arm64
chmod +x ocr && sudo mv ocr /usr/local/bin/ocr

# macOS (Intel)
curl -Lo ocr https://github.com/Lab-Overflow/open-code-review/releases/latest/download/opencodereview-darwin-amd64
chmod +x ocr && sudo mv ocr /usr/local/bin/ocr

# Linux (x86_64)
curl -Lo ocr https://github.com/Lab-Overflow/open-code-review/releases/latest/download/opencodereview-linux-amd64
chmod +x ocr && sudo mv ocr /usr/local/bin/ocr

# Linux (ARM64)
curl -Lo ocr https://github.com/Lab-Overflow/open-code-review/releases/latest/download/opencodereview-linux-arm64
chmod +x ocr && sudo mv ocr /usr/local/bin/ocr

# Windows (x86_64) — переместите ocr.exe в каталог из вашего PATH
curl -Lo ocr.exe https://github.com/Lab-Overflow/open-code-review/releases/latest/download/opencodereview-windows-amd64.exe

# Windows (ARM64) — переместите ocr.exe в каталог из вашего PATH
curl -Lo ocr.exe https://github.com/Lab-Overflow/open-code-review/releases/latest/download/opencodereview-windows-arm64.exe
```
...
```bash
/plugin marketplace add Lab-Overflow/open-code-review
...
curl -o .claude/commands/open-code-review.md \
  https://raw.githubusercontent.com/Lab-Overflow/open-code-review/main/plugins/open-code-review/commands/review.md
```
...
| Ключ | Тип | Пример |
|------|-----|--------|
| `provider` | string | `anthropic` \| `openai` \| `deepseek` \| `z-ai` |
...
[![Star History Chart](https://api.star-history.com/svg?repos=Lab-Overflow/open-code-review&type=Date)](https://star-history.com/#Lab-Overflow/open-code-review&Date)
