...
- **Suggest features** — Have an idea for improvement? You can start a conversation in [GitHub Discussions](https://github.com/Lab-Overflow/open-code-review/discussions/categories/ideas) or open a [Feature Request](https://github.com/Lab-Overflow/open-code-review/issues/new?template=feature_request.yml) issue.
- **Improve documentation** — Fix typos, clarify explanations, or add examples. You can also open a [Documentation Issue](https://github.com/Lab-Overflow/open-code-review/issues/new?template=docs_report.yml) to report problems.
...
git remote add upstream https://github.com/Lab-Overflow/open-code-review.git
...
1. If you spot an issue but don't plan to fix it yourself, open a [Documentation Issue](https://github.com/Lab-Overflow/open-code-review/issues/new?template=docs_report.yml).
...
We require all contributors to sign the Contributor License Agreement before we can merge your contributions. This ensures that the project can be distributed under its license terms.
...
- [`good first issue`](https://github.com/Lab-Overflow/open-code-review/labels/good%20first%20issue) — Small, well-scoped tasks ideal for getting started.
- [`help wanted`](https://github.com/Lab-Overflow/open-code-review/labels/help%20wanted) — Issues where we'd appreciate community help.
...
- **Bug Reports** — [GitHub Issues](https://github.com/Lab-Overflow/open-code-review/issues)
- **Feature Suggestions** — [GitHub Discussions (Ideas)](https://github.com/Lab-Overflow/open-code-review/discussions/categories/ideas) or [Feature Request Issue](https://github.com/Lab-Overflow/open-code-review/issues/new?template=feature_request.yml)
- **Questions & Help** — If you have any questions about using OpenCodeReview, feel free to ask in [GitHub Discussions](https://github.com/Lab-Overflow/open-code-review/discussions)
