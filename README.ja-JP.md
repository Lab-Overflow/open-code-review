...
Open Code Reviewは、Lab-Overflowが個人のオープンソースプロジェクトとして保守するAIコードレビューCLIツールです。ローカル開発やCIワークフローに、構造化された行単位のAIレビューを導入することを目的としています。モデルのエンドポイントを設定するだけで使い始められます。
...
詳細は[公式サイト](https://lab-overflow.github.io/open-code-review/)をご覧ください。
...
[GitHub Releases](https://github.com/Lab-Overflow/open-code-review/releases)からお使いのプラットフォーム向けのバイナリをダウンロードします：
