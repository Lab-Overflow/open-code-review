...
Open Code Review 是一款由 Lab-Overflow 以个人身份维护的 AI 驱动代码审查 CLI 工具。它旨在为本地开发和 CI 工作流提供结构化、行级精度的 AI 审查能力。只需配置一个模型端点即可使用。
...
访问[官方网站](https://lab-overflow.github.io/open-code-review/)了解更多信息。
...
从 [GitHub Releases](https://github.com/Lab-Overflow/open-code-review/releases) 下载适用于你平台的二进制文件：
