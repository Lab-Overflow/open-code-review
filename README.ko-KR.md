...
Open Code Review는 Lab-Overflow가 개인 오픈 소스 프로젝트로 유지 관리하는 AI 기반 코드 리뷰 CLI 도구입니다. 로컬 개발 및 CI 워크플로에 구조화된 라인 단위 AI 리뷰를 도입하도록 설계되었습니다. 모델 endpoint만 설정하면 바로 사용할 수 있습니다.
...
자세한 내용은 [공식 웹사이트](https://lab-overflow.github.io/open-code-review/)를 참조하세요.
...
[GitHub Releases](https://github.com/Lab-Overflow/open-code-review/releases)에서 사용 중인 플랫폼의 binary를 다운로드합니다.
