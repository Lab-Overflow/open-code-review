...
func TestLookupProvider_KnownProviders(t *testing.T) {
	names := []string{"anthropic", "openai", "deepseek"}
...
func TestListProviders_Order(t *testing.T) {
	...
	expected := []string{"anthropic", "baidu-qianfan", "deepseek", "hy-tokenplan", "kimi", "mimo", "minimax", "openai", "tencent-tokenhub", "volcengine", "z-ai", "z-ai-coding"}
