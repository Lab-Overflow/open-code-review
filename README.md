...
Open Code Review is an AI-powered code review CLI tool maintained by Lab-Overflow as a personal open source project. It is designed to bring structured, line-level AI review into local and CI workflows. Simply configure a model endpoint to get started.
...
Visit the [official website](https://lab-overflow.github.io/open-code-review/) for more details.
...
Download the binary for your platform from [GitHub Releases](https://github.com/Lab-Overflow/open-code-review/releases):
